...
public class StartMenu extends JFrame {
	...
	private Image tetrisBackground = new ImageIcon(cl.getResource("tetrisBackground.png"))
			.getImage();
	private ImageIcon menuStartClicked = new ImageIcon(cl.getResource("menuStartClicked.png"));
	private ImageIcon menuStartPressed = new ImageIcon(cl.getResource("menuStartClicked.png"));
	private ImageIcon menuStartBasic = new ImageIcon(cl.getResource("menuStart.png"));
	private JButton menuStart = new JButton(menuStartBasic);

	private ImageIcon menuOptionClicked = new ImageIcon(cl.getResource("menuOptionClicked.png"));
	private ImageIcon menuOptionBasic = new ImageIcon(cl.getResource("menuOption.png"));
	private JButton menuOption = new JButton(menuOptionBasic);

	private ImageIcon menuSBClicked = new ImageIcon(cl.getResource("menuSBClicked.png"));
	private
	ImageIcon menuSBBasic = new ImageIcon(cl.getResource("menuSB.png"));
	private JButton menuSB = new JButton(menuSBBasic);

	private ImageIcon menuExitClicked = new ImageIcon(cl.getResource("menuExitClicked.png"));
	private ImageIcon menuExitBasic = new ImageIcon(cl.getResource("menuExit.png"));
	private JButton menuExit = new JButton(menuExitBasic);

	private ImageIcon iconClicked = new ImageIcon(cl.getResource("tetrisIconClicked.png"));
	private ImageIcon iconBasic = new ImageIcon(cl.getResource("tetrisIcon.png"));
	private JButton icon = new JButton(iconBasic);

	private ImageIcon itemStartClicked = new ImageIcon(cl.getResource("itemStartClicked.png"));
	private ImageIcon itemStartBasic = new ImageIcon(cl.getResource("itemStart.png"));
	private JButton itemStart = new JButton(itemStartBasic);

	private ImageIcon normalStartClicked = new ImageIcon(cl.getResource("normalStartClicked.png"));
	private ImageIcon normalStartBasic = new ImageIcon(cl.getResource("normalStart.png"));

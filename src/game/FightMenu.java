...
public class FightMenu extends JFrame implements KeyListener {
	...
	public void pause() {
		if (!timer.isRunning()) {
			...
			timer.stop();
			gameBoard1.gamePane.settext("PAUSE");
			gameBoard2.gamePane.settext("PAUSE");
		}
	}
	...
	protected void gameOver() {
		...
		if(gameBoard1.getScore()>gameBoard2.getScore()) {
			gameBoard1.gamePane.settext("WIN!");
			gameBoard2.gamePane.settext("LOSE");
		} else {
			gameBoard1.gamePane.settext("LOSE");
			gameBoard2.gamePane.settext("WIN!");
		}
	}

...
public class SettingItem {
    ...
    public static final int MEDIUM_HEIGHT = 590;
    public static final int LARGE_HEIGHT = 670;

    public static final int SMALL_FONT = 19;
    public static final int MEDIUM_FONT = 23;
    public static final int LARGE_FONT = 27;

    private SettingItem() throws IOException {
    	SettingFile saveFile = new SettingFile();
    ...
    public static SettingItem getInstance() throws IOException {
        if(instance == null) return new SettingItem();
        return instance;
    }
